...
public class EditProductActivity extends Activity
{
	...
	// this.categoryAdapter = new ArrayAdapter<Category>(this, R.layout.spinner_type_row_normal,
	// Category.values());
	...
	//
	// ArrayAdapter<Type> typeAdapter = new ArrayAdapter<Type>(this, R.layout.spinner_type_row_normal,
	// category.getTypes())
	// {
	// @Override
	...
	// String name = nameField.getText().toString();
	//
	// Product updatedProduct = new Product(this.product.getId(), name, type, this.product.getQuantity(),
